...
# Simple Object Tracker using YOLO and ByteTrack
class Tracker:
    ...
    def interpolate_ball_positions(self, ball_positions):
        ball_poisitons = [x.get(1,{}).get('bbox',[]) for x in ball_positions]
        df_ball_positions = pd.DataFrame(ball_poisitons, columns=['x1', 'y1', 'x2', 'y2'])
    ...
    def detect_frames(self, frames):
        ...
        # Return results of the models predictions
        return detections
    ...
    def get_object_tracks(self, frames, read_from_stub = False, stub_path = None):
        ...
        # Assign class names of the models detection to cls_names
        for frame_num, detection in enumerate(detections):
            ...
            # Track Objects
            # Assigning track IDs to detections across frames
            detection_with_tracks = self.tracker.update_with_detections(detection_supervision)
            
            # Store tracked objects in dictionary
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        # Draw semi-transparernt rectangle
        overlay = frame.copy()
        ...
        # Get number of times each team has had ball control
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            # Drawing circle beneath player, ball, referee
